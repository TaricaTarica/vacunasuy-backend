...
a persistence unit "comp-centPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "comp-cent\pom.xml":
...
artifacts ("comp-cent-ejb.jar" and "comp-cent-web.war") are already built. You can build
